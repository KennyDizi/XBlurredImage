...
using XBlurredImage.Droid.SourceCode.Renderers;

[assembly: ExportRenderer(typeof(XBlurredImage.SourceCode.Controls.XBlurredImage), typeof(BlurredImageRenderer))]

namespace XBlurredImage.Droid.SourceCode.Renderers
{
    public class BlurredImageRenderer : ViewRenderer<XBlurredImage.SourceCode.Controls.XBlurredImage, ImageView>
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<XBlurredImage.SourceCode.Controls.XBlurredImage> e)
        {
